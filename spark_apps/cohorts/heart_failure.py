...
# WORSEN_HF_DX_COHORT = """
# WITH 
# worsen_hf_dx_concepts AS (
# SELECT DISTINCT descendant_concept_id AS concept_id 
# FROM global_temp.concept_ancestor AS ca
# WHERE ca.ancestor_concept_id IN {worsen_hf_dx_concepts}
# )

# SELECT DISTINCT person_id, visit_occurrence_id 
# FROM global_temp.condition_occurrence AS co
# JOIN worsen_hf_dx_concepts AS c
# ON co.condition_concept_id = c.concept_id
# """

# PHY_EXAM_COHORT = """
# WITH
# phy_exam_concepts AS (
# SELECT DISTINCT descendant_concept_id AS concept_id
# FROM global_temp.concept_ancestor AS ca
# WHERE ca.ancestor_concept_id IN {phy_exam_concepts}
# )

# SELECT DISTINCT person_id, visit_occurrence_id
# FROM global_temp.condition_occurrence AS co
# JOIN phy_exam_concepts AS c
# ON co.condition_concept_id = c.concept_id
# """
...
# SELECT DISTINCT descendant_concept_id AS concept_id
# FROM global_temp.concept_ancestor AS ca
# WHERE ca.ancestor_concept_id IN {bnp_concepts}
# )

# SELECT DISTINCT person_id, visit_occurrence_id
# FROM global_temp.measurement AS m
# JOIN bnp_concepts AS l
...
# NT_PRO_BNP_COHORT = """
# WITH
# nt_pro_bnp_concepts AS (
# SELECT DISTINCT descendant_concept_id AS concept_id
# FROM global_temp.concept_ancestor AS ca
# WHERE ca.ancestor_concept_id IN {nt_pro_bnp_concepts}
# )
...
# SELECT DISTINCT descendant_concept_id AS concept_id
# FROM global_temp.concept_ancestor AS ca
# WHERE ca.ancestor_concept_id IN {drug_concept}
# )
...
# MECHANICAL_SUPPORT_COHORT = """
# WITH
# mechanical_support_concepts AS (
# SELECT DISTINCT descendant_concept_id AS concept_id
# FROM global_temp.concept_ancestor AS ca
# WHERE ca.ancestor_concept_id IN {mechanical_support_concept})

# SELECT DISTINCT person_id, visit_occurrence_id
# FROM global_temp.procedure_occurrence AS p
# JOIN mechanical_support_concepts AS mc
# ON p.procedure_concept_id = mc.concept_id
# """
...
# SELECT DISTINCT descendant_concept_id AS concept_id
# FROM global_temp.concept_ancestor AS ca
# WHERE ca.ancestor_concept_id IN {dialysis_concept})

# SELECT DISTINCT person_id, visit_occurrence_id
# FROM global_temp.procedure_occurrence AS p
# JOIN dialysis_concepts AS dc
# ON p.procedure_concept_id = dc.concept_id
# """

# ARTIFICIAL_HEART_COHORT = """
# WITH
# artificial_heart_concepts AS (
# SELECT DISTINCT descendant_concept_id AS concept_id
# FROM global_temp.concept_ancestor AS ca
# WHERE ca.ancestor_concept_id IN {artificial_heart_concept})

# SELECT DISTINCT person_id, visit_occurrence_id
# FROM global_temp.procedure_occurrence AS p
# JOIN artificial_heart_concepts AS ac
# ON p.procedure_concept_id = ac.concept_id)"""
...
# SELECT DISTINCT descendant_concept_id AS concept_id
# FROM global_temp.concept_ancestor AS ca
# WHERE ca.ancestor_concept_id IN {pwp_concepts}
# )

# SELECT DISTINCT person_id, visit_occurrence_id
# FROM global_temp.measurement AS m
# JOIN pwp_concepts AS l
# on m.measurement_concept_id = l.concept_id
# and m.value_source_value >= 18
# )"""
...
# SELECT DISTINCT descendant_concept_id AS concept_id
# FROM global_temp.concept_ancestor AS ca
# WHERE ca.ancestor_concept_id IN {cvp_concepts}
# )

# SELECT DISTINCT person_id, visit_occurrence_id
# FROM global_temp.measurement AS m
# JOIN cvp_concepts AS l
# on m.measurement_concept_id = l.concept_id
# and m.value_source_value >= 12
# )"""
...
# SELECT DISTINCT descendant_concept_id AS concept_id
# FROM global_temp.concept_ancestor AS ca
# WHERE ca.ancestor_concept_id IN {ci_concepts}
# )

# SELECT DISTINCT person_id, visit_occurrence_id
# FROM global_temp.measurement AS m
# JOIN ci_concepts AS l
# on m.measurement_concept_id = l.concept_id
# and m.value_source_value < 2.2
# )
# """
