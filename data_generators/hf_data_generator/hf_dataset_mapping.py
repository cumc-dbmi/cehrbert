...
def meds_to_cehrbert_extension(meds_record: Patient) -> CehrBertPatient:
    ...
    for e in events:
        ...
        if e['properties']['visit_id'] and e['properties']['table'] != 'visit':
            visit_mapping[e['properties']['visit_id']]['events'].append(e)
