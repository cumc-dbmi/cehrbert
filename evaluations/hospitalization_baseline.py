...
from data_generators.data_generator import BertFineTuningDataGenerator
...
heart_failure_folder = '/data/research_ops/omops/omop_2020q2/training_data_2010/hospitalization_rolled_up_fc'
...
# +
X = hstack([normalized_concept_freq_count, one_hot_gender_race, scaled_age])
