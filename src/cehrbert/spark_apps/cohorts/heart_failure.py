...
BNP_CONCEPT = [
    ...
    3011960,
    3052295,
]  # High B-type Natriuretic Peptide (BNP) > 500 pg/mL
NT_PRO_BNP_CONCEPT = [3029187, 42529224, 3029435, 42529225]
PWP_CONCEPT = [
    1002721,
    4040920,
    21490776,
]  # Pulmonary artery wedge pressure >= 18 no patient in cumc
CVP_CONCEPT = [
    21490675,
    4323687,
    3000333,
    1003995,
]  # Central venous pressure >= 12 no patient in cumc
...
MECHANICAL_CIRCULATORY_SUPPORT_CONCEPT = [
    45888564,
    4052536,
    4337306,
    2107514,
...
def query_builder():
    query = QuerySpec(
        ...
        parameters={
            "intermediate_heart_failure": INTERMEDIATE_COHORT_NAME,
            "inclusion": 1,
        },
    )
    ...
    dependency_queries = [
        QuerySpec(
            table_name=DIURETICS_INGREDIENT_CONCEPTS,
            query_template=ROLL_UP_DIURETICS_TO_INGREDIENT_TEMPLATE,
            parameters={},
        ),
        QuerySpec(
            table_name=INTERMEDIATE_COHORT_NAME,
            query_template=HEART_FAILURE_INTERMEDIATE_COHORT_QUERY,
            parameters={
                "hf_concept": HEART_FAILURE_CONCEPT_TABLE,
