...
class DataTrainingArguments:
    ...
    cohort_folder: Optional[str] = dataclasses.field(
        default=None,
        metadata={
            "help": "The name of the cohort generated by ACES or OHDSI cohort builder."
        },
    )
    ...
    preprocessing_batch_size: Optional[int] = dataclasses.field(
        default=10000,
        metadata={
            "help": "The batch size to use for preprocessing a streaming dataset"
        },
    )
    ...
    #  list right now.
    meds_to_cehrbert_conversion_type: Literal[MedsToBertMimic4.__name__] = (
        dataclasses.field(
    ...
    vocab_size: Optional[int] = dataclasses.field(
        default=50_000,
        metadata={
            "help": "The maximum vocab size allowed for the tokenizer trainer to use"
        },
    )
    min_frequency: Optional[int] = dataclasses.field(
        default=0,
        metadata={
            "help": "The minimum frequency for concepts to be kept by the tokenizer"
        },
    )
...
class ModelArguments:
    ...
    finetune_model_type: Literal[
        FineTuneModelType.POOLING.value, FineTuneModelType.LSTM.value
    ] = dataclasses.field(
    ...
    exclude_position_ids: Optional[bool] = dataclasses.field(
        default=False,
        metadata={
            "help": "Whether or not to exclude position ids from the transformer model"
        },
    )
    ...
    use_sub_time_tokenization: Optional[bool] = dataclasses.field(
        default=True,
        metadata={
            "help": "Whether or not to decompose the time interval into year/month/day"
        },
    )
    include_value_prediction: Optional[bool] = dataclasses.field(
        default=True,
        metadata={
            "help": "Whether or not to include value prediction head for cehrbert"
        },
    )
